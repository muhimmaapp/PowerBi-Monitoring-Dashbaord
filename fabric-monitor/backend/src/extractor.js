    ...
    try {
      ...
      for (const event of dayEvents) {
        ...
        activities.push({
          ...
          tenantLabel: label,
          workspaceName: event.WorkspaceName || event.WorkSpaceName || null,
          workspaceId: event.WorkspaceId || null,
          itemName: event.ArtifactName || event.ReportName || event.DashboardName || event.DatasetName || event.DataflowName || null,
          itemId: event.ArtifactId || event.ReportId || event.DashboardId || event.DatasetId || event.DataflowId || null,
          itemType: event.ItemType || event.ArtifactType || null,
